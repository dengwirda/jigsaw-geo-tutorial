...
def get_msh_t(msht,mshl):
    ...
    #--------------------------------- copy buffer for RADII
        ...
        jlib.jigsaw_free_reals(ct.byref(mshl.radii))
    ...
    #--------------------------------- copy buffer for VERT2
        ...
        jlib.jigsaw_free_vert2(ct.byref(mshl.vert2))
    ...
    #--------------------------------- copy buffer for VERT3
        ...
        jlib.jigsaw_free_vert3(ct.byref(mshl.vert3))
    ...
    #--------------------------------- copy buffer for POWER
        ...
        jlib.jigsaw_free_reals(ct.byref(mshl.power))
    ...
    #--------------------------------- copy buffer for EDGE2
        ...
        jlib.jigsaw_free_edge2(ct.byref(mshl.edge2))
    ...
    #--------------------------------- copy buffer for TRIA3
        ...
        jlib.jigsaw_free_tria3(ct.byref(mshl.tria3))
    ...
    #--------------------------------- copy buffer for QUAD4
        ...
        jlib.jigsaw_free_quad4(ct.byref(mshl.quad4))
    ...
    #--------------------------------- copy buffer for TRIA4
        ...
        jlib.jigsaw_free_tria4(ct.byref(mshl.tria4))
    ...
    #--------------------------------- copy buffer for HEXA8
        ...
        jlib.jigsaw_free_hexa8(ct.byref(mshl.hexa8))
    ...
    #--------------------------------- copy buffer for WEDG6
        ...
        jlib.jigsaw_free_wedg6(ct.byref(mshl.wedg6))
    ...
    #--------------------------------- copy buffer for PYRA5
        ...
        jlib.jigsaw_free_pyra5(ct.byref(mshl.pyra5))
    ...
    #--------------------------------- copy buffer for XGRID
        ...
        jlib.jigsaw_free_reals(ct.byref(mshl.xgrid))
    ...
    #--------------------------------- copy buffer for YGRID
        ...
        jlib.jigsaw_free_reals(ct.byref(mshl.ygrid))
    ...
    #--------------------------------- copy buffer for ZGRID
        ...
        jlib.jigsaw_free_reals(ct.byref(mshl.zgrid))
    ...
    #--------------------------------- copy buffer for VALUE
        ...
        jlib.jigsaw_free_reals(ct.byref(mshl.value))
    ...
    #--------------------------------- copy buffer for SLOPE
        ...
        jlib.jigsaw_free_reals(ct.byref(mshl.slope))
